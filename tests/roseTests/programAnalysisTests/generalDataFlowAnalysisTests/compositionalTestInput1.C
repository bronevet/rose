...
int main()
{
  ...
  CompDebugAssert(a==1, b==2, c==3, Y==806);
  ...
  CompDebugAssert(a==1, b==2, c==3, Y==806, array[1]==1307);
  // ConstProp: a=1, b=2, c=3, d=4, Y=806, array[1]=1307
  // LiveDead: a, b, c, d, Y, array[1]
  array[b] = Y;
  
  CompDebugAssert(a==1, b==2, c==3, array[1]==1307, array[2]==806);
  ...
  CompDebugAssert(b==2, c==3, array[2113]==1307, array[2113]==array[array[d/d]+array[d-b]], array2D[3][2309]==806);
  ...
  CompDebugAssert(array[c]==2309, array[3]==array[c], array2D[3][2309]==806);
