...
int main()
{
	...
	int x=10;
	int y=20;
	CompDebugAssert(w==15, x==10, y==20);
	int z = max(x, y);
	int array[1000];

	// ConstProp: w=15, x=10, y=20, z=20
	CompDebugAssert(w==15, x==10, y==20, z==20);
	array[z] = min(w,z);
	
	// ConstProp: w=15, x=10, y=20, z=20, array[20]==15
	CompDebugAssert(w==15, x==10, y==20, z==20, array[20]==15);
	if(array[y]==15) {
		// ConstProp: w=15, x=10, y=20, z=15, array[20]==15
		CompDebugAssert(w==15, x==10, y==20, z==20, array[y]==15);
		array[array[y]]=123;
	} else {
		// ConstProp: w=15, x=10, y=20, z=15, array[20]!=15
		CompDebugAssert(w==15, x==10, y==20, z==20/*, array[y]!=15*/);
